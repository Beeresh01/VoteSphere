...
$sql = "SELECT 
            ...
            ROUND(COALESCE(SUM(p2.total_votes), 0) * 100.0 / 
                NULLIF((
                    ...
                    FROM sports2 
                    WHERE position = 'Sports-Secreatary'
                ), 0), 1) AS percentage
        FROM 
            sports p
        LEFT JOIN 
            sports2 p2 ON p.id = p2.candidate_id AND p.position = p2.position
        WHERE 
            p.position = 'Sports-Secreatary'
        GROUP BY 
...
<!-- Header -->
<header class="header">
  <h1><i class="fas fa-trophy"></i> Sports-Secreatary Election Results</h1>
  <p>Official results for the 2025 University Student Union Sports-Secreatary Election</p>
</header>

<!-- Main Content -->
<div class="container">
  <section class="post-section">
    <h2>🎓 Sports-Secreatary Candidates</h2>
