...
$sql = "SELECT 
        ...
        FROM 
            vicepresident p
        LEFT JOIN 
            vice2 p2 ON p.id = p2.candidate_id AND p.position = p2.position
        WHERE 
...
<!-- Header -->
<header class="header">
  <h1><i class="fas fa-trophy"></i> Vice-President Election Results</h1>
  <p>Official results for the 2025 University Student Union Vice-President Election</p>
</header>
...
<footer class="footer">
  <div class="footer-content">
    <div class="footer-column">
      <h3>About VoteShere</h3>
      <p>VoteShere is the official student election system of the university, providing transparent and secure voting for all student government elections.</p>
