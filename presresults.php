...
$sql = "SELECT 
        ...
        FROM 
            president p
        LEFT JOIN 
            president2 p2 ON p.id = p2.candidate_id AND p.position = p2.position
        WHERE 
...
<!-- Header -->
<header class="header">
  <h1><i class="fas fa-trophy"></i> President Election Results</h1>
  <p>Official results for the 2025 University Student Union President Election</p>
</header>
